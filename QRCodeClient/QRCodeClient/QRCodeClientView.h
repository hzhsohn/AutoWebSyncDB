...
// QRCodeClientView.h : CQRCodeClientView 类的接口
//
...
public:
	...
	// m_pSelection 将所选内容保存在当前的 CQRCodeClientCntrItem 中。
	// 对于许多应用程序，这种成员变量不足以
	//  表示某个选择，例如在不属于 CQRCodeClientCntrItem 的对象中
	//  选定的一个或多个对象。提供这种选择
	//  机制的目的只是帮助您入门
...
#ifndef _DEBUG  // QRCodeClientView.cpp 中的调试版本
